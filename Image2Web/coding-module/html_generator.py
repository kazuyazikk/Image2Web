...
def generate_html (elements):
    ...
    for i, el in enumerate(elements):
        ...
        #Might want to include heading tags (h1,h2,h3,etc.)
            ...
            tag = f'<nav class="navbar-base {class_name}"><a href="javascript:void(0)" onclick="event.preventDefault(); return false;">Home</a><a href="javascript:void(0)" onclick="event.preventDefault(); return false;">About</a><a href="javascript:void(0)" onclick="event.preventDefault(); return false;">Contact</a></nav>'
        elif el["label"] == "paragraph":
